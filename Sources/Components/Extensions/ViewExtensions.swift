...
extension View {
    /// Use this method in order to show a  certain `SpinnerView` on top of current view that is blurred out
    /// - Parameters:
    ///   - binding: Defines if the view should be visible or not
    ///   - color: The color of dots
    /// - Returns:  A new  animated `SpinnerView` `View` presented on top of blurred out `View`
